...
vsp_k2_reports_00conf_dedup <- import_kraken2_summary(vsp_dir_00conf_dedup,
                                                      "report.tsv")
rpip_k2_reports_00conf_dedup <- import_kraken2_summary(rpip_dir_00conf_dedup,
                                                      "report.tsv")
unt_k2_reports_00conf_dedup <- import_kraken2_summary(unt_dir_00conf_dedup,
                                                      "report.tsv")
...
#Import k2 reports with k2 confidence of 0.9
vsp_k2_reports_90conf_dedup <- import_kraken2_summary(vsp_dir_90conf_dedup,
                                                      "report.tsv")
rpip_k2_reports_90conf_dedup <- import_kraken2_summary(rpip_dir_90conf_dedup,
                                                       "report.tsv")
unt_k2_reports_90conf_dedup <- import_kraken2_summary(unt_dir_90conf_dedup,
                                                      "report.tsv")
...
all_k2_reports_anyConf_dedup <- bind_rows(vsp_k2_reports_00conf_dedup,
